...
DangKiTaiKhoanMoi-1
    [Documentation]    Telephone đạt độ dài tối thiểu và tối đa:
...
DangKiTaiKhoanMoi-1.1
    [Documentation]    Telephone ngắn hơn độ dài tối thiểu:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.2
    [Documentation]    Telephone dài hơn độ dài tối đa:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.3
    [Documentation]    Telephone chứa ký tự không phải số:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.4
    [Documentation]    Telephone chỉ chứa ký tự số và ký tự đặc biệt:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.5
    [Documentation]    Telephone chứa ký tự khoảng trắng:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.6
    [Documentation]    Telephone có chứa ký tự đặc biệt không hợp lệ:
...
DangKiTaiKhoanMoi-1.7
    [Documentation]    Telephone có độ dài chính xác 10 ký tự:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.8
    [Documentation]    Telephone có độ dài chính xác 3 ký tự:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
