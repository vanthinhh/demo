...
DangKiTaiKhoanMoi-1
    [Documentation]    Company đạt độ dài tối thiểu và tối đa:
...
DangKiTaiKhoanMoi-1.1
    [Documentation]    Company ngắn hơn độ dài tối thiểu:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.2
    [Documentation]    Company dài hơn độ dài tối đa:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.3
    [Documentation]    Company chỉ chứa ký tự không phải chữ cái và số:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
...
DangKiTaiKhoanMoi-1.4
    [Documentation]    Company chứa ký tự đặc biệt không hợp lệ:
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Set Selenium Speed    0.5
