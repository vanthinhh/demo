...
*** Test Cases ***
Register with the Password Confirm: having no characters (empty) and check the constraint: [Documentation] Đăng ký với trường Password Confirm: không có ký tự nào (rỗng) và kiểm tra ràng buộc:
